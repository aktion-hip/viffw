...
/** Returns the criterium's value. This class is used to render the SQL filter condition of normal SQL statements.
 *
 * @author Luthiger Created on 11.07.2007 */
@SuppressWarnings("serial")
public class CriteriumValueStrategy implements IGetValueStrategy { // NOPMD by lbenno 
    ...
    public String getValue(final KeyCriterion inCriterion) { // NOPMD by lbenno 
        ...
        return String.format("%1$s%2$s%1$s", lSQLValue.getDelimiter(), lSQLValue.getValueAsString());
    }
