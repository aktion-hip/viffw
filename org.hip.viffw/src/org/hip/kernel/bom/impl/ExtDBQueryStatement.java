...
/** Statement to query an additional database while using <code>DefaultQueryStatement</code> to retrieve the main bulk of
 * data.
 *
 * @author Luthiger Created on 16.04.2007 */
...
public class ExtDBQueryStatement extends AbstractQueryStatement {
    ...
    public ExtDBQueryStatement(final GeneralDomainObjectHome inHome, final DBAccessConfiguration inConfiguration) {
        super(inHome);
     ...
     * 
     * @param inConfiguration {@link DBAccessConfiguration} */
    public void setConnectionSetting(final DBAccessConfiguration inConfiguration) {
        dbConfiguration = inConfiguration;
    }
