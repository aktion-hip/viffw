...
/** This class can be used to serialize DomainObjects with String type properties whose values contain text formated
 * according to StructuredText rules. This serializer converts these formatings to HTML text.
 *
 * @author Luthiger Created on 29.05.2008
 * @see org.hip.kernel.bom.impl.EscapedHTMLSerializer */
@SuppressWarnings("serial")
public class HTMLSerializer extends AbstractStructuredTextSerializer { // NOPMD by lbenno

    /** Returns the correct StructuredTextSerializer to serialize DomainObjects with text formated according to
     * StructuredText rules. In this case returns an instance of
