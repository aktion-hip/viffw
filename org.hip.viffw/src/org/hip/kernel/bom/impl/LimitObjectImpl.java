...
public class LimitObjectImpl extends VObject implements LimitObject {
    ...
    public LimitObjectImpl(final int inNumber) {
        super();
        number = inNumber;
    }
    ...
    public LimitObjectImpl(final int inNumber, final int inOffset) {
        super();
        number = inNumber;
        offset = inOffset;
    }
    ...
    public Object[] getArguments() {
        return new Object[] { Integer.valueOf(number), Integer.valueOf(offset) };
    }
}
