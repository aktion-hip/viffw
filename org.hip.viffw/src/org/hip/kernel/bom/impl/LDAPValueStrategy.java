...
/** Returns the criterium's value. This class is used to render the filter condition of LDAP statements.
 *
 * @author Luthiger Created on 24.07.2007 */
@SuppressWarnings("serial")
public class LDAPValueStrategy implements IGetValueStrategy { // NOPMD by lbenno 
    ...
    public String getValue(final KeyCriterion inCriterion) { // NOPMD by lbenno 
        ...
        return lSQLValue.getValueAsString();
    }
