...
public interface RelationshipDefDef extends MetaModelObject { // NOPMD by lbenno 
    String homeName = "homeName".intern(); // NOPMD by lbenno 
    String keyDefName = "keyDefName".intern(); // NOPMD by lbenno 
