...
/** This is a generic interface for sortable values. This interface may be used to create a sorted list of elements, e.g.
 * a list of columnNames used for the SQL ORDER BY clause.
 *
