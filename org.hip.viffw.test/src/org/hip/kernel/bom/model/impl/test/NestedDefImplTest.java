...
public class NestedDefImplTest {
    ...
    public void testGetNestedQuery() {
        ...
        try {
            ...
            assertEquals("nested", lExpected, this.nestedDef.getNestedQuery());
        }
    ...
    public void testGetSQLColumnName() {
        ...
        try {
            ...
            assertEquals("SQL column name 1", lExpected, this.nestedDef.getSQLColumnName("Test"));
            assertEquals("SQL column name 2", lExpected, this.nestedDef.getSQLColumnName("GroupID"));
        }
        catch (final Exception exc) {
            fail(exc.getMessage());
        }
