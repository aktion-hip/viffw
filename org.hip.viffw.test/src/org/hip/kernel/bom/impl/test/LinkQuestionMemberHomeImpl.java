...
public class LinkQuestionMemberHomeImpl extends DomainObjectHomeImpl {
	/** Every home has to know the class it handles. They provide access to
		this name through the method <I>getObjectClassName</I>;
	*/
	private final static String TESTOBJECT_CLASS_NAME = "org.hip.kernel.bom.impl.test.LinkQuestionMemberImpl" ;
	...
	*/
	...
	private final static String XML_OBJECT_DEF = 
		...
		"<objectDef objectName='LinkQuestionMember' parent='org.hip.kernel.bom.DomainObject' version='1.0'>			\n" +
		"	<keyDefs>			\n" +
		"		<keyDef>			\n" +
		"			<keyItemDef seq='0' keyPropertyName='QuestionID'/>			\n" +
		"			<keyItemDef seq='1' keyPropertyName='MemberID'/>			\n" +
		"		</keyDef>			\n" +
		"	</keyDefs>			\n" +
		"	<propertyDefs>			\n" +
		"		<propertyDef propertyName='QuestionID' valueType='Number' propertyType='simple'>			\n" +
		"			<mappingDef tableName='tblLinkQuestionMember' columnName='QUESTIONID'/>			\n" +
		"		</propertyDef>			\n" +
		"		<propertyDef propertyName='MemberID' valueType='Number' propertyType='simple'>			\n" +
		"			<mappingDef tableName='tblLinkQuestionMember' columnName='MEMBERID'/>			\n" +
		"		</propertyDef>			\n" +
		"		<propertyDef propertyName='IsAuthor' valueType='Number' propertyType='simple'>			\n" +
		"			<mappingDef tableName='tblLinkQuestionMember' columnName='BAUTHOR'/>			\n" +
		"		</propertyDef>			\n" +
		"	</propertyDefs>			\n" +
		"</objectDef>			";
/**
 ...
 */
public LinkQuestionMemberHomeImpl() {
	super();
}
/**
